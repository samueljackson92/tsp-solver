...
My solution to this assignment is implemented as a Python module with a basic command line interface. The installation of the module and the operation of the command line interface are described in appendices \ref{appendix:installation} and \ref{appendix:cli} respectively.
